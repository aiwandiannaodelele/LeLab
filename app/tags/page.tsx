        ...
        <div className="flex flex-wrap gap-3">
          {tags.map(({ tag, count }) => (
            <Link
              key={tag}
              href={`/tags/${tag}`}
              className="group inline-flex items-center gap-2 rounded-2xl border border-border/60 px-4 py-2.5 text-sm transition-all hover:border-primary/40 hover:bg-primary/5 hover:text-primary"
            >
